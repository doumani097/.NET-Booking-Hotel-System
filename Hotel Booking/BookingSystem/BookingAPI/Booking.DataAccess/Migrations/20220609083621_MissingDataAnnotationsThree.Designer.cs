...
namespace BookingAPI.DataAccess.Migrations
{
    ...
    [Migration("20220609083621_MissingDataAnnotationsThree")]
    partial class MissingDataAnnotationsThree
    {
            ...
            modelBuilder.Entity("BookingAPI.Models.HotelLocation", b =>
                {
                    b.HasOne("BookingAPI.Models.Hotel", "Hotel")
                        .WithOne("HotelLocation")
                        .HasForeignKey("BookingAPI.Models.HotelLocation", "HotelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookingAPI.Models.Location", "Location")
                        .WithOne("HotelLocation")
                        .HasForeignKey("BookingAPI.Models.HotelLocation", "LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
